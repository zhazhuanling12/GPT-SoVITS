...
class Synthesis:
    ...
    def test(self, ref_text, ref_audio_path, target_text, output_wav_path, language_combobox='Chinese', language_combobox_02='Chinese'):
...
def main():
    ...
    handler = Synthesis(GPT_model_path='GPT_SoVITS/pretrained_models/s1bert25hz-2kh-longer-epoch=68e-step=50232.ckpt', SoVITS_model_path='GPT_SoVITS/pretrained_models/s2G488k.pth')
    target_texts = ['小绿出门找吃的东西了，他找到一个红薯后回家了。', 
