...
def train_s1_model(
    ...
    GPT_weight_root = os.path.join(exp_name, "GPT_weight")
    ...
    cmd = 'python GPT_SoVITS/s1_train.py --config_file "%s" ' % (tmp_config_path,)
    os.system(cmd)
...
def main():
    ...
    # train_s1_model(exp_name=opt_dir)
    train_s2_model(exp_name=opt_dir)
