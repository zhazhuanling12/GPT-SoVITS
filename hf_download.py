...
try:
    ...
    os.system("pip install -U huggingface_hub -i https://pypi.tuna.tsinghua.edu.cn/simple")
...
if args.use_hf_transfer:
    ...
    try:
        ...
        os.system("pip install -U hf-transfer -i https://pypi.tuna.tsinghua.edu.cn/simple")
